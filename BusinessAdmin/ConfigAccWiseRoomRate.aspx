<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/BusinessAdmin.Master" AutoEventWireup="true" CodeBehind="ConfigAccWiseRoomRate.aspx.cs" Inherits="e_Travel.BusinessAdmin.ConfigAccWiseRoomRate" %>
...
<asp:UpdatePanel runat="server" ID="UpdatePanel1">
        <ContentTemplate>
          <div class = "BoxHeader">Accomodation Wise Room Configuration</div>
        <div class = "BoxBody">
        <div class = "BoxContent">
        <fieldset>
         <legend>Accomodation Wise Room Configuration</legend>
         <%--<div class="row">
         ...
         <div class="row">
          <label for="AccDropDown" style="width:200px;">Accomodation</label>
                            <asp:DropDownList ID="AccDropDown" runat="server" ValidationGroup="ValidateData" Width = "665px" AppendDataBoundItems="True">
                            </asp:DropDownList>
         </div>
           <%--<div class="row">
                 <label for="DestinationDropDown" style="width:200px;">Destination</label>
                ...
                <div class="FromBodyButtonContainer">
                  <asp:Button ID="AddButton" runat="server" Text=" Add " CssClass="FromBodyButton" 
                   ...
                   <asp:Button ID="SaveButton" runat="server" Text=" Save " 
                        CssClass="FromBodyButton" ValidationGroup="ValidateData" Width="80px" onclick="SaveButton_Click" 
                        />
