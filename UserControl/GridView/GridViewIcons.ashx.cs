...
namespace e_Travel.UserControl.GridView
{
    /// <summary>
    /// Summary description for GridViewIcons
    /// </summary>
    public class GridViewIcons : IHttpHandler
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            FileStream fs = File.OpenRead(HttpContext.Current.Server.MapPath("~/UserControl/GridView/Images/Sprite.png"));
